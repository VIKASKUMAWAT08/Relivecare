...
import { Calendar, Clock, User, Phone, Mail, CheckCircle2, AlertCircle, Loader2, Sparkles, ShieldCheck, MessageSquare, ExternalLink } from 'lucide-react';
...
export function Appointment({ preselectedTreatment, preselectedDoctor }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Also log request in backend store
    ...
    <section id="appointment" className="py-16 sm:py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <SectionHeading
          ...
          title="Schedule Your In-Person Physiotherapy Consultation"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-900 text-white p-7 rounded-3xl border border-slate-800 shadow-xl space-y-5">
              ...
              <div className="pt-3 space-y-3.5 text-xs text-slate-300 border-t border-slate-800">
              ...
              <div className="bg-slate-800/80 p-3.5 rounded-2xl border border-slate-700 text-xs text-slate-300">
          ...
          <div className="lg:col-span-7">
            <div className="bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm relative">
              
              {/* WhatsApp Request Prepared Alert */}
              {submissionState && (
                <div className="mb-6 p-5 rounded-2xl bg-teal-950 text-white border border-teal-700 shadow-xl animate-in fade-in zoom-in-95">
                    ...
                    <div className="space-y-2 flex-1">
                      ...
                      <div className="pt-2 flex flex-wrap gap-2.5">
                        <a
                          ...
                          className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-md transition-all active:scale-98"
                        >
                        ...
                        <button
                          ...
                          type="button"
                          className="px-3 py-2 text-xs font-medium text-slate-300 hover:text-white underline cursor-pointer"
                        >
              ...
              {errors.form && (
                <div className="mb-6 p-4 rounded-xl bg-red-50 text-red-800 border border-red-200 text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Patient Name */}
                <div>
                  <label htmlFor="patientName" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-xl border bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:ring-2 transition-all ${
                        errors.patientName
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Phone */}
                  <div>
                    <label htmlFor="phoneNumber" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                  ...
                  {/* Email */}
                  <div>
                    <label htmlFor="email" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-300 bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all"
                      />
                    </div>
                    {errors.email && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Date */}
                  <div>
                    <label htmlFor="preferredDate" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                  ...
                  {/* Time Slot */}
                  <div>
                    <label htmlFor="preferredTime" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-300 bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all cursor-pointer"
                      >
                ...
                <div>
                  <label htmlFor="treatmentConcern" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                    Treatment Concern / Specialty <span className="text-teal-600">*</span>
                  </label>
                  <select
                    id="treatmentConcern"
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl border bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:ring-2 transition-all cursor-pointer ${
                      errors.treatmentConcern
                        ? 'border-red-400 focus:ring-red-400'
                        : 'border-slate-300 focus:border-teal-500 focus:ring-teal-500/20'
                    }`}
                  >
                    <option value="">-- Please select your condition or concern --</option>
                ...
                {/* Preferred Doctor */}
                <div>
                  <label htmlFor="preferredDoctor" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all cursor-pointer"
                  >
                    <option value="Any Available Specialist">Any Available Specialist</option>
                    <option value="Dr. Virendra Kumawat (BPT)">Dr. Virendra Kumawat (BPT)</option>
                    <option value="Dr. Kamlesh Mahariya (BPT)">Dr. Kamlesh Mahariya (BPT)</option>
                  </select>
                </div>

                {/* Additional Message / Symptoms */}
                <div>
                  <label htmlFor="message" className="block text-xs font-bold text-slate-900 uppercase tracking-wider mb-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="Describe pain location, duration, past surgeries, or specific questions..."
                    className="w-full px-4 py-3 rounded-xl border border-slate-300 bg-white text-xs sm:text-sm text-slate-900 focus:outline-hidden focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition-all"
                  ></textarea>
                </div>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-xl bg-teal-700 hover:bg-teal-800 text-white font-bold text-sm shadow-md hover:shadow-lg transition-all active:scale-98 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
                  >
                    {isSubmitting ? (
                      <>
