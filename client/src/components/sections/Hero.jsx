...
import { Calendar, Phone, Star, CheckCircle2, Activity, UserCheck } from 'lucide-react';
import { CLINIC_INFO } from '../../config/clinicData';
import { IMAGES } from '../../config/images';

export function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white pt-10 sm:pt-16 pb-16 lg:pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
              Specialized clinical physiotherapy, manual therapy, and personalized rehabilitation programs dedicated to relieving pain, restoring joint mobility, and accelerating functional recovery.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-2 text-xs text-slate-300 max-w-xl mx-auto lg:mx-0">
              ...
              <div className="flex items-center gap-2 bg-slate-800/60 p-2.5 rounded-xl border border-slate-700/60">
                <CheckCircle2 className="w-4 h-4 text-teal-400 shrink-0" />
                <span>1-on-1 Patient Attention</span>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-4">
              <a
                href="#appointment"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-bold text-sm shadow-lg shadow-teal-500/20 transition-all hover:scale-101 active:scale-98"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white font-semibold text-sm border border-slate-700 transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-sm shadow-md transition-all hover:scale-101 active:scale-98"
              >
                <span>WhatsApp</span>
              </a>
            </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              {/* Doctor Visual Card */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-slate-700 bg-slate-800 aspect-4/3 sm:aspect-4/5 max-h-[520px]">
                <img
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <p className="text-teal-300 text-[11px] font-medium mt-0.5">
                        BPT • Physiotherapist &amp; Rehabilitation Specialist
                      </p>
                    </div>
              ...
              <div className="absolute -top-3 -right-2 sm:-right-3 bg-slate-900/95 backdrop-blur-md px-3.5 py-2.5 rounded-xl border border-teal-500/40 shadow-xl flex items-center gap-2.5">
